...
function MouseTracker(props) {
    ...
    var _b = useState(false); _b[0]; var setClick = _b[1];
    ...
    return jsx("div", __assign({ onMouseEnter: function () { return changeHover(true); }, onMouseLeave: function () { return changeHover(false); }, onMouseDown: function () { return changeClick(true); }, onMouseUp: function () { return changeClick(false); }, onClick: props.onClick, style: __assign(__assign({}, style), props.style) }, { children: props.children }));
}
...
var PlainButton = function (_) {
    ...
    return jsx("div", __assign({ className: "button-plain", style: style }, { children: jsx(MouseTracker, __assign({ changeHover: setHover, changeClick: setClick, onClick: disabled ? undefined : onClick }, { children: text })) }));
};
...
var Footer = function (props) {
    ...
    return jsx("div", __assign({ style: style, className: 'turboComp-footer' }, { children: children }));
};
...
var FooterButton = function (props) {
    return jsx("div", __assign({ className: "turboComp-footer-button turboComp-smalltext", style: props.style, onClick: props.onClick }, { children: props.text }));
};
...
var FooterSection = function (props) {
    return jsxs("div", __assign({ style: props.style }, { children: [jsxs("div", __assign({ className: 'turboComp-smalltext turboComp-footer-sectiontext' }, { children: [" ", props.text, " "] })), jsxs("div", __assign({ className: 'turboComp-footer-sectioncontent' }, { children: [" ", props.children, " "] }))] }));
};
...
var Header = function (props) {
    ...
    return jsxs("div", __assign({ style: style, className: 'turboComp-header' }, { children: [jsx("div", __assign({ className: 'turboComp-header-navs' }, { children: Navs })), jsx("div", __assign({ className: 'turboComp-header-title' }, { children: props.title })), jsx("div", __assign({ className: 'turboComp-header-other' }, { children: Other }))] }));
};
...
var HeaderNav = function (props) {
    ...
    return jsxs("div", __assign({ className: "turboComp-header-nav", style: style }, { children: [jsx("div", { className: "turboComp-header-nav-indicator", style: indicatorStyle }), jsx(MouseTracker, __assign({ changeHover: setHover, changeClick: setClick, onClick: props.onClick }, { children: props.text }))] }));
};
...
var StyleProvider = function (props) {
    ...
    return jsx("div", __assign({ style: props.style, className: "turboComp-root" }, { children: children }));
};
...
var Debug = function (props) {
    ...
    return jsx("div", { className: 'turboComp-debug', style: style });
};
...
var Position = function (props) {
    ...
    return jsx("div", __assign({ className: 'turboComp-position', style: style }, { children: props.children }));
};
...
var Card = function (props) {
    ...
    var buttonsBase = Buttons.length > 0 ?
        jsxs("div", __assign({ className: 'turboComp-card-buttons' }, { children: [jsx("div", { className: 'turboComp-card-divider', style: divstyle }), jsx("div", __assign({ className: 'turboComp-card-buttonpos' }, { children: Buttons }))] }))
        : null;
    var labelTop = props.title ?
        jsx("div", __assign({ className: 'turboComp-card-label', style: styleTitle }, { children: props.title }))
        : null;
    return jsxs("div", __assign({ className: 'turboComp-card', style: style }, { children: [Other, buttonsBase, labelTop] }));
};
...
export { Card, Collect, ColorPallet as Color, Debug, Footer, FooterButton, FooterSection, Header, HeaderNav, PlainButton, Position, StyleProvider };
